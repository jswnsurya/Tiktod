...
vidUrl = "https://www.tiktok.com/@freefiregive_away/video/6892801100399922434?sender_device=pc&sender_web_id=6883199833952650753&is_from_webapp=1" #Change YOUR_URL to your Tik Tok video URL. This URL used to get views or hearts or both
#username = "freefiregive_away" #Change YOUR_USERNAME to your Tik Tok username

system("cls")
tiktokbot = pyfiglet.figlet_format("TIKTOD", font="slant")
print(tiktokbot)
print("Author: https://github.com/jswnsurya")
print("")
